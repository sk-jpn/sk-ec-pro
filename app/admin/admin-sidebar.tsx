...
export function AdminSidebar() {
  ...
  return <aside className="border-b border-slate-200 bg-white lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:w-64 lg:border-b-0 lg:border-r">
    <div className="flex h-16 items-center justify-between px-5 lg:h-20 lg:px-6"><Link href="/admin" className="flex items-center gap-3"><Image src={withBasePath("/brand/icon-512.png")} width={36} height={36} alt="SK EC Pro" className="rounded-lg" /><span><span className="block text-sm font-bold">SK EC Pro</span><span className="block text-[10px] font-medium uppercase tracking-widest text-slate-400">Admin</span></span></Link><span className="rounded-full bg-emerald-50 px-2 py-1 text-[10px] font-semibold text-emerald-700">DEMO</span></div>
