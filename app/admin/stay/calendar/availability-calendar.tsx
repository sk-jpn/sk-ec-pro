...
type CalendarDay = null | { day: number; date: string; available: boolean; past: boolean; listingClosed: boolean; bookings: { id: string; number: string; status: string }[]; blocks: { id: string; label: string; reason: string }[] };
