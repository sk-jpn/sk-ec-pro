...
export function ProfileForm({ profile }: { profile: Profile }) {
  ...
  return <form action={action} className="space-y-5">
    <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-5"><p className="text-xs font-bold uppercase tracking-[.16em] text-blue-600">Deposit</p><p className="mt-2 text-2xl font-bold text-blue-950">¥{new Intl.NumberFormat("ja-JP").format(profile.deposit_balance)}</p><p className="mt-2 text-xs leading-5 text-blue-700">ご利用いただけるデポジットです。</p></div>
