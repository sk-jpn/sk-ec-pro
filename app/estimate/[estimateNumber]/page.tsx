          ...
          <div className="mx-auto mt-10 max-w-4xl overflow-hidden rounded-[2rem] border border-blue-100 bg-white shadow-2xl shadow-blue-950/8 sm:mt-14">
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mt-10 border-t border-slate-100 pt-8">
                <PaymentPanel estimateNumber={estimate.estimate_no} estimateTotal={totals.total} initialPaymentMethod={estimate.payment_method} approved={Boolean(estimate.approved_at)} paid={estimate.status === "paid" || Boolean(estimate.paid_at)} cancelled={estimate.status === "キャンセル"} />
              </div>
            </div>
          </div>
        </div>
