...
export const metadata: Metadata = {
  ...
  description:
    "Taobao、Tmall、1688、Alibaba、Xianyu、REDなどの中国EC商品をお客様に代わって購入し、日本へ発送します。当社運営のYahoo!ショッピング・Amazonもご案内しています。",
  openGraph: {
    title: "SK EC Pro | 中国ECを、もっと簡単に。もっと安心に。",
    description:
      "Taobao、Tmall、1688、Alibaba、Xianyu、REDなどの中国EC商品をお客様に代わって購入し、日本へ発送します。",
    type: "website",
    url: SITE_URL,
    siteName: "SK EC Pro",
    locale: "ja_JP",
